...
import { TrialVoteType } from '@mafia/managers/VoteManager';
...
@ApplyOptions<CommandOptions>({
	description: 'commands/help:guiltyDescription',
	detailedDescription: 'commands/help:guiltyDetailed',
...
export default class extends GodfatherCommand {
	public async run(message: Message) {
		...
		await game.votes.trialVote(game.players.get(message.author)!, TrialVoteType.Guilty).then(() => message.react('✅'));
	}
}
